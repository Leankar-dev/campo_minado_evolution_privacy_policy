...
**Last updated / Última atualização / Última actualización / Dernière mise à jour / Ultimo aggiornamento:** 2026-05-24
...
Thank you for playing **Campo Minado Evolution** ("the App"), developed by **Leankar.dev**. This Privacy Policy explains what information is collected, how it is used, and your rights regarding that information. By using the App, you agree to the practices described in this policy.
...
All locally stored data (game statistics, saved games, and preferences) resides only on your device. You can delete this data at any time by:
...
Obrigado por jogar **Campo Minado Evolution** ("o Aplicativo"), desenvolvido por **Leankar.dev**. Esta Política de Privacidade explica quais informações são coletadas, como são utilizadas e quais são os seus direitos em relação a essas informações. Ao utilizar o Aplicativo, você concorda com as práticas descritas nesta política.
...
Todos os dados armazenados localmente (estatísticas, jogos salvos e preferências) residem apenas no seu dispositivo. Você pode excluí-los a qualquer momento:
...
Podemos atualizar esta Política de Privacidade periodicamente. As alterações serão refletidas pela atualização da data "Última atualização" no topo deste documento. Recomendamos que você revise esta política periodicamente.

#### 8. Contato

Em caso de dúvidas ou preocupações sobre esta Política de Privacidade, entre em contato conosco:

- **Desenvolvedor:** Leankar.dev
- **E-mail:** leankar.dev@gmail.com
- **Website:** https://leankar.dev
...
Gracias por jugar **Campo Minado Evolution** ("la Aplicación"), desarrollada por **Leankar.dev**. Esta Política de Privacidad explica qué información se recopila, cómo se utiliza y cuáles son sus derechos con respecto a dicha información. Al utilizar la Aplicación, usted acepta las prácticas descritas en esta política.
...
Todos los datos almacenados localmente (estadísticas, partidas guardadas y preferencias) residen únicamente en su dispositivo. Puede eliminarlos en cualquier momento:
...
Podemos actualizar esta Política de Privacidad periódicamente. Los cambios se reflejarán actualizando la fecha de "Última actualización" en la parte superior de este documento. Le recomendamos que revise esta política periódicamente.
...
- **Correo electrónico:** leankar.dev@gmail.com
- **Sitio web:** https://leankar.dev
...
**Date d'entrée en vigueur :** 24 mai 2026

#### 1. Introduction

Merci de jouer à **Campo Minado Evolution** (« l'Application »), développée par **Leankar.dev**. Cette Politique de Confidentialité explique quelles informations sont collectées, comment elles sont utilisées et quels sont vos droits concernant ces informations. En utilisant l'Application, vous acceptez les pratiques décrites dans cette politique.
...
Toutes les données stockées localement (statistiques, parties sauvegardées et préférences) résident uniquement sur votre appareil. Vous pouvez les supprimer à tout moment :
...
Nous pouvons mettre à jour cette Politique de Confidentialité périodiquement. Les modifications seront reflétées par la mise à jour de la date de « Dernière mise à jour » en haut de ce document. Nous vous encourageons à consulter cette politique régulièrement.
...
**Data di entrata in vigore:** 24 maggio 2026

#### 1. Introduzione

Grazie per giocare a **Campo Minado Evolution** ("l'App"), sviluppata da **Leankar.dev**. Questa Informativa sulla Privacy spiega quali informazioni vengono raccolte, come vengono utilizzate e quali sono i tuoi diritti in merito a tali informazioni. Utilizzando l'App, accetti le pratiche descritte in questa informativa.
...
Tutti i dati archiviati localmente (statistiche, partite salvate e preferenze) risiedono solo sul tuo dispositivo. Puoi eliminarli in qualsiasi momento:
...
Potremmo aggiornare periodicamente questa Informativa sulla Privacy. Le modifiche saranno rispecchiate aggiornando la data di "Ultimo aggiornamento" in cima a questo documento. Ti invitiamo a consultare periodicamente questa informativa.

#### 8. Contatti

Per domande o dubbi riguardanti questa Informativa sulla Privacy, contattaci:

- **Sviluppatore:** Leankar.dev
- **E-mail:** leankar.dev@gmail.com
- **Sito web:** https://leankar.dev
